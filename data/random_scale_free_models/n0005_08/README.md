...
A random scale-free model: topology from networkx's directed scale-free generator (seed 5008), with a uniformly random symmetric threshold function per non-input node - random signs, and a threshold drawn uniformly from [1, in-degree].
