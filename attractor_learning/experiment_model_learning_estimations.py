...
def perform_graph_learning_tests(G, node_measurement_prob=node_measurement_prob, n_experiments=n_bio_experiments,
    ...
    # prepare attractor states to sample from
    ...
    average_ilp_time = sum(ilp_times) / float(len(ilp_times))
    average_solve_time = sum(solve_times) / float(len(solve_times))
    return average_similarity, average_test_agreement, average_test_time, average_ilp_time, average_solve_time
...
ModelLearningResult = namedtuple("ModelLearningResult", "graph_name size "
                                                    ...
                                                    "average_test_time "
                                                    "average_ilp_time average_solve_time"
                                )
...
def main():
    ...
    for graph, graph_name in zip(tested_graphs, graph_names):
        ...
        average_similarity, average_test_agreement, average_test_time, average_ilp_time, average_solve_time = \
            perform_graph_learning_tests(graph)
        ...
        result = ModelLearningResult(graph_name, size, n_inputs, normaliezd_n_inputs, max_degree, mean_degree,
                                     ...
                                     limit_experiments_to_short_attractors, average_similarity, average_test_agreement,
                                     average_test_time, average_ilp_time, average_solve_time)
