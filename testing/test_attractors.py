        ...
        while n_random_experiment < 10:
            ...
            for n_component in range(n_components):  # TODO: change to graph union method
                ...
                if comp_type == "acyclic":
                    ...
                    restriction_level = random.randint(1, 3)
                    component_graph.randomize_functions(restrict_signed_symmetric_threshold=(restriction_level > 1),
                                                        restrict_and_or_gates=(restriction_level == 3))
                    input_nodes = 0
                    for v in V:
                        is_input = True
                        for e in E:
