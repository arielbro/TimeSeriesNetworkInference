    ...
    def test_find_num_attractors_onestage(self):
        ...
        G = graphs.Network(
            ...
            vertex_functions=[None, None, sympy.Nand, None, None, None, None, None, None, None, None, None, None, None,
                              ...
                              sympy.And, sympy.And])
        experiments.append(AttractorExperimentParameters(G=G, T=1, P=6, n_attractors=6))
        experiments.append(AttractorExperimentParameters(G=G, T=1, P=10, n_attractors=10))
        experiments.append(AttractorExperimentParameters(G=G, T=2, P=10, n_attractors=10))
        # 49, 50, 51
        ...
        experiments.append(AttractorExperimentParameters(G=G, T=1, P=15, n_attractors=12))
        experiments.append(AttractorExperimentParameters(G=G, T=2, P=15, n_attractors=14))
        experiments.append(AttractorExperimentParameters(G=G, T=3, P=15, n_attractors=14))
